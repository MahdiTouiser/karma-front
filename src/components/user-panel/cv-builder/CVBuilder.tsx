...
const CVBuilder = () => {
    return (
        <div className="m-4 overflow-hidden shadow-2xl bg-gradient-to-br from-cyan-500 to-blue-600 rounded-3xl sm:m-6 md:m-8 lg:m-10">
            <div className="container px-6 py-16 mx-auto sm:px-8 md:px-12 lg:px-16 sm:py-20 md:py-24 lg:py-32">
                <div className="flex flex-col items-center justify-between space-y-12 md:flex-row md:space-y-0 md:space-x-12 lg:space-x-20">
                    <div className="max-w-2xl text-center text-white md:text-left">
                        ...
                        <p className="mb-10 text-xl sm:text-2xl md:text-3xl opacity-90">
                            با رزومه ساز کارما
                        </p>
                        <Link
