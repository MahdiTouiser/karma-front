  ...
  return (
    <div className="bg-white pt-6">
      {links.map((link, index) => {
        return (
          <NavLink key={index} to={link.path} className={nav => `${nav.isActive ? 'bg-slate-200' : ''} flex  gap-2 px-3 py-4 transition-colors duration-75 ease-linear hover:bg-slate-200`}>
            <div>{link.icon}</div>
