              ...
              <Table.Head>
                {selectable && (
                  <Table.HeadCell className="w-5 px-3 pl-0">
                    {/* <input
                      type="checkbox"
                      className="w-5 h-5 text-primary-500 bg-gray-200 border-gray-300 rounded focus:ring-primary-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                    /> */}
                  </Table.HeadCell>
                )}
