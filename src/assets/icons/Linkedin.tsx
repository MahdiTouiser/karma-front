...
const Linkedin: React.FC<LinkedinProps> = ({ strokeColor = 'none', className = 'ml-2 h-8 w-8' }) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' fill="#0077B5" stroke={strokeColor} viewBox='0 0 24 24' className={className}>
