...
import { DocumentItem, DocumentItemModel, DocumentsList, DocumentStatus } from '../models/account.models'
...
function getLastDocument(documents: DocumentItem[] | null, withDate?: boolean, required = true): DocumentItemModel {
...
function getRelatedTimeStamp(state: AccountState, field: UserDocumentsFieldType) {
...
const accountSlice = createSlice({
  ...
  reducers: {
    ...
    setDocumentFile: (state, action: PayloadAction<{ field: UserDocumentsFieldType; fileId: string }>) => {
    ...
    setDocumentExpireDate: (state, action: PayloadAction<{ field: UserDocumentsFieldType; date: string }>) => {
